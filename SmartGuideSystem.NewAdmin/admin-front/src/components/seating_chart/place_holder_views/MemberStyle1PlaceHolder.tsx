  ...
  switch (item.size) {
    case "Large":
      return (
        <>
          <div
            className={`${cn} absolute left-[53%] top-[50%] translate-y-[-50%]`}
          >
    ...
    case "Small":
      return (
        <>
          <div
            className={`${cn} absolute left-[55%] top-[50%] translate-y-[-50%]`}
          >
            <div className="font-[500] text-[22px]">
              <p className="font-[500] text-[20px]">{item.member.name}</p>
              <p className="font-[500] text-[12px]">{profileGrade}</p>
            </div>
          </div>
          <ProfileImage
...
export default observer(function MemberStyle1PlaceHolder({
  item,
  className,
  onSelectItem,
}: Props) {
  ...
  if (item.templateName === TemplateNames.template_member_style1_member) {
    return (
      <ChartNode
        x={item.posX}
        y={item.posY}
    ...
    item.templateName === TemplateNames.template_member_style1_leader1
  ) {
    return (
      <ChartNode
        x={item.posX}
    ...
    item.templateName === TemplateNames.template_member_style1_leader2
  ) {
    return (
      <ChartNode
        x={item.posX}
