...
export default function ProfileCardLayout({
  ...
  return (
    <div
      ...
      className={` overflow-hidden relative ${roundedCn}  bg-white shadow-[5px_3px_0px_rgba(92,98,125,1)] ${className}`}
    >
      <div
        className={`absolute rounded-full aspect-square h-[76%] left-[0%] top-[48%] translate-y-[-50%] ${cn2}`}
      />
      <div
        className={`absolute rounded-full aspect-square h-[76%] translate-x-[-40%] left-0 top-[48%] translate-y-[-50%] ${cn1} `}
      />
...
export function LeaderCardLayout({
  ...
  return (
    ...
    >
      <div
        className={`absolute rounded-full aspect-square h-[72%] left-[0%] top-[9%]  ${cn2}`}
      />
      <div
        className={`absolute rounded-full aspect-square h-[72%] translate-x-[-40%] left-0 top-[9%]  ${cn1} `}
      />
...
export function DepartLeaderCardLayout({
  ...
  return (
    ...
    >
      <div
        className={`absolute rounded-full aspect-square h-[60%] left-[6%] top-[8%]  ${cn2}`}
      />
      <div
        className={`absolute rounded-full aspect-square h-[60%] translate-x-[-40%] left-0 top-[8%]  ${cn1} `}
      />
