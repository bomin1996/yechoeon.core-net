...
import MemberStyle2PlaceHolder from "./Templates/MemberStyle2PlaceHolder";
...
export default function MemberNode({ memberNode }: Props) {
  ...
  if (memberNode.templateName === "member1") {
    ...
    memberNode.templateName === "member_style1_member" ||
    memberNode.templateName === "member_style1_leader1" ||
    memberNode.templateName === "member_style1_leader2"
  ) {
    return (
    ...
    memberNode.templateName === "member_style2_member" ||
    memberNode.templateName === "member_style2_leader1" ||
    memberNode.templateName === "member_style2_leader2"
  ) {
    return (
