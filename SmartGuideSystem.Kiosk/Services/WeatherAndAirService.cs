...
namespace SmartGuideSystem.Kiosk.Services
{
    public class WeatherAndAirService
    {
        ...
        {
            // full api url 
            // http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMsrstnAcctoRltmMesureDnsty?pageNo=1&ver=1.0&numOfRows=2&returnType=json&dataTerm=DAILY&stationName=%EC%83%81%EB%8C%80%EB%8F%99(%EC%A7%84%EC%A3%BC)&ServiceKey=ip%2Bs4oBTLr0QFYfawRo4uqhUgnWuRFSuK0rrcoElzCg%2BzqBXoubwoG60U8Cf5CE9K6YwFif3JAGI2YsSotEnfQ%3D%3D
